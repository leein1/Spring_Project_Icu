		...
		<div class = main-body>
			...
			<div class="list-area">
				...
				<form role="form" class="list-body" action="/photoboard/write" method="post">
					...
					<!-- 테스트용 히든  -->
					<input type="hidden" value='<sec:authentication property="principal.user.email"/>' name="email">
			...
			<div class="margin-right">
				...
				<%-- <div class="user-area">
					...
					<div class="user-profile-text">
						<p>닉네임 : <sec:authentication property="principal.user.nickname"/></p>
...
<script>
	...
	$(document).ready(function(e){
		...
		function preventModification(event) {
		  event.preventDefault(); // 이벤트 기본 동작(수정/삭제)을 막음
		  return false; // 이벤트 전파를 막음
		}

		// .uploadResult의 내용 수정/삭제를 막음
		uploadResult.addEventListener('input', preventModification);
		uploadResult.addEventListener('keydown', preventModification);
		uploadResult.addEventListener('paste', preventModification);
		uploadResult.addEventListener('cut', preventModification);
